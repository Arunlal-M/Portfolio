...
const Scene = () => {
  ...
  useEffect(() => {
    if (canvasDiv.current) {
      ...
      let handleResizeWrapper: (() => void) | null = null;
      ...
      loadCharacter().then((gltf) => {
        if (gltf) {
          ...
          scene.add(character);
          headBone = character.getObjectByName("mixamorigHead") 
          ...
          handleResizeWrapper = () => handleResize(renderer, camera, canvasDiv, character);
